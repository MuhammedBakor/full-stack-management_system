...
import com.moba.managementsystem.model.IssueDTO;
import com.moba.managementsystem.model.User;
import com.moba.managementsystem.request.CreateCommentRequest;
import com.moba.managementsystem.request.IssueRequest;
import com.moba.managementsystem.response.MessageResponse;
import com.moba.managementsystem.service.CommentService;
import com.moba.managementsystem.service.IssueService;
...
public class CommentController {
    ...
    public ResponseEntity<Comment> createComment(
        ...
        Comment createdComment = commentService.createdComment(
                req.getIssueId(),
                user.getId(),
                req.getContent());
